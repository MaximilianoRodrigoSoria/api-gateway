package com.ar.laboratory.apigateway.example.infrastructure.web.controller;
...
import com.ar.laboratory.apigateway.example.application.inbound.command.CreateExampleCommand;
import com.ar.laboratory.apigateway.example.application.inbound.command.FindExampleByDniCommand;
import com.ar.laboratory.apigateway.example.application.inbound.command.ListExamplesCommand;
import com.ar.laboratory.apigateway.example.application.query.ExampleFilter;
import com.ar.laboratory.apigateway.example.domain.exception.ExampleAlreadyExistsException;
...
import com.ar.laboratory.apigateway.example.infrastructure.inbound.web.controller.ExampleController;
import com.ar.laboratory.apigateway.example.infrastructure.inbound.web.dto.CreateExampleRequest;
import com.ar.laboratory.apigateway.example.infrastructure.inbound.web.dto.ExampleResponse;
import com.ar.laboratory.apigateway.example.infrastructure.inbound.web.mapper.ExampleDtoMapper;
import com.ar.laboratory.apigateway.shared.infrastructure.config.GlobalExceptionHandler;
