package com.ar.laboratory.apigateway.shared.infrastructure.metrics;
...
public class UseCaseMetricsAspect {
     ...
     */
    @Around(
            "execution(* com.ar.laboratory.apigateway..application.inbound.command..*(..))"
                    + " && !within(com.ar.laboratory.apigateway..infrastructure..*)")
